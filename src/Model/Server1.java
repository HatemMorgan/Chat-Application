...
public class Server1 {
   static final int Port = 5000; // this is the port where the server is listenning to
	SView serverWindow;
	                ...
	                serverWindow.getTextArea().setCaretPosition(serverWindow.getTextArea().getDocument().getLength());
	                  ...
	                  else if (data[2].equals("chat")) 
	                  {
	                	  ...
	                	  for (ClientConnected c : ClientsConnectedList) {
	          				if(c.name.equals(DestinationName)){
	          					DestinationID= ClientsConnectedList.indexOf(c);
	          				}
	          				}
	          				if(DestinationID!=-1){
	                	  ...
	                	  SendMessageToDestination(message, data[3]);
	          					...
	          					int TTL=Integer.parseInt(data[4]);
	          					TTL--;
	          					String ToServerMessage=data[0]+":"+data[1]+":"+data[2]+":"+data[3]+":"+TTL;
